...
if not architect.headings:
    print("❌ No headings found. Did you run architect.process_pdf() yet?")
else:
    ...
    print("--- 📊 ARCHITECT HEADING AUDIT ---")
    print(f"✅ Total Headings Found: {len(architect.headings)}")
    print(f"🔄 Duplicates Detected: {duplicates if duplicates else 'None'}")
    print("\n📜 FULL HEADING SEQUENCE (In Order):")
    ...
    if "Deep Sea Plain" in duplicates:
        print("\n💡 INSIGHT: 'Deep Sea Plain' is duplicated. Sequential logic will skip the first hit (the list) and summarize the second hit (the actual content).")
...
if 'architect' in globals() and architect.final_output:
    ...
    print("🚀 DONE! Download 'Professional_Handwritten_Notes.pdf' from the file sidebar.")
else:
    print("❌ No text found. Make sure you ran the architect.process_pdf() step!")